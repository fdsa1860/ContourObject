function [dists, paths] = get_loop2(W_seg, nb_loops, start_id, s2b, vec)
...
for node1 = 1:numel(start_id)
    curr_bin_id = bin_id(start_id(node1));
    ...
    [cost pred] = bellman_ford_sp(-W_seg_dag, start_id(node1));
    cost = -cost;
